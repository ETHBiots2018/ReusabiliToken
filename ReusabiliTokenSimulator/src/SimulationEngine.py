...
class SimulationEngine(object):
    """
    This is the engine that runs the market simulation
    """
    ...
    def run(self, claim_failure_probability=0.00001):
        ...
        for day in range(self.sim_iters):
            ...
            # iterate over every customer in the market
            for customer in self.customers:
                # see where the customer wants to buy stuff from
                ...
                # choose if the customer has something to recycle
                ...
                if recyling_decision is True:
                    ...
                    if self._simulate_claim_failure(prob=claim_failure_probability):
                        ...
                        # smart contract verification will succeed
                        ...
                        if res is True:
                            ...
                            if customer.get_reputation(shop_address) > self.smart_contract.reputation_limit:
                                # special case to handle the upper limit on the customer reputation
                                customer.set_reputation(shop_address, self.smart_contract.reputation_limit)
                            else:
                                customer.transfer_reputation(reps, shop_address)

            # after every self.payment_due days, all shops pay their dues to the smart contract and the owner of the
            # smart contract initiates a payment check
            ...
            # deteriorate customer reputation at every simulation step to prevent infinite hoarding of reputations
    ...
    def _create_customers(self, customer_distribution):
        ...
        for i in range(self.num_customers):
            ...
            if customer_type == 0:
                ...
                nc += 1
        print('good customers: {}\tbad customers: {}\tneutral customers: {}'.format(gc, bc, nc))
        return customers
